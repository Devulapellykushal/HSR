    ...
    <section className="py-10 sm:py-12 md:py-16 bg-[#2E936B] text-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-8 text-white/90 max-w-2xl mx-auto">
          Contact us today to explore our premium residential projects and find the perfect home for your family.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
          ...
          {callLink && (
            <Link
              href={callLink}
              className="w-full sm:w-auto px-5 sm:px-6 md:px-7 py-2.5 sm:py-3 bg-[#4CAF7D] hover:bg-[#3d8f6a] text-white rounded-lg font-semibold text-sm sm:text-base transition-colors shadow-lg flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
