        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
          ...
          {whatsappLink && (
            <Link
              ...
              className="w-full sm:w-auto px-5 sm:px-6 md:px-7 py-2.5 sm:py-3 rounded-lg bg-[#2E936B] hover:bg-[#247556] text-white font-semibold text-sm sm:text-base transition-colors flex items-center justify-center gap-2 shadow-lg"
            >
