	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.createTable(
			new Table({
				...
				columns: [
					{
						name: 'family_member_personal_detail_id',
						type: 'uuid',
						isPrimary: true,
		...
		await queryRunner.createForeignKey(
			...
			new TableForeignKey({
				...
				referencedColumnNames: ['family_member_id'],
				onDelete: 'CASCADE',
				onUpdate: 'CASCADE',
			}),
		);
		await queryRunner.createForeignKey(
			...
			new TableForeignKey({
				...
				referencedColumnNames: ['blood_group_id'],
				onDelete: 'RESTRICT',
				onUpdate: 'CASCADE',
			}),
		);
		await queryRunner.createForeignKey(
			...
			new TableForeignKey({
				...
				referencedColumnNames: ['clothing_size_id'],
				onDelete: 'RESTRICT',
				onUpdate: 'CASCADE',
			}),
		);
		...
		await queryRunner.createForeignKey(
			...
			new TableForeignKey({
				...
				referencedColumnNames: ['shoe_size_id'],
				onDelete: 'RESTRICT',
				onUpdate: 'CASCADE',
			}),
		);
